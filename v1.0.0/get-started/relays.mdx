...
<Frame>
  <img src="/v0.8.0/images/mev-commit-relay.png" alt="mev-commit relay diagram" />
</Frame>

- If they have opted in, your relay only accepts blocks from mev-commit builders:
<Frame>
  <img src="/v0.8.0/images/mev-commit-validator-relay.png" alt="mev-commit validator relay diagram" />
</Frame>
...
PROVIDER_REGISTRY_ADDR={ProviderRegistryAddress0_7_0}
  ...
  <Step title="Register Your Relay">
    1. Add your relay to our [supporting relays list](/v0.8.0/get-started/validators/validator-guide#supporting-relays)
