...
---
import { ProviderRegistryAddressMainnet1_0_0 } from '/snippets/mainnet-addresses.mdx';
...
<Frame>
  <img src="/v1.0.0/images/mev-commit-relay.png" alt="mev-commit relay diagram" />
</Frame>

- If they have opted in, your relay only accepts blocks from mev-commit builders:
<Frame>
  <img src="/v1.0.0/images/mev-commit-validator-relay.png" alt="mev-commit validator relay diagram" />
</Frame>
