...
<p> The mev-commit chain uses native ETH that must be bridged from L1 using a standard lock and mint bridge. A user CLI application can be downloaded from the [releases page](https://github.com/primev/mev-commit/releases/latest). </p>
...
* [Darwin x86_64](https://github.com/primev/mev-commit/releases/download/v1.0.0/mev-commit-bridge-user-cli_1.0.0_Darwin_x86_64.tar.gz)
...
* [Linux x86_64](https://github.com/primev/mev-commit/releases/download/v1.0.0/mev-commit-bridge-user-cli_1.0.0_Linux_x86_64.tar.gz)
* [Windows x86_64](https://github.com/primev/mev-commit/releases/download/v1.0.0/mev-commit-bridge-user-cli_1.0.0_Windows_x86_64.zip)
