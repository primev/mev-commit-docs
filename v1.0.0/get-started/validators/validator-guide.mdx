...
See [mainnet](/v1.0.0/developers/mainnet#l1-validator-registries) and [testnet](/v1.0.0/developers/testnet#validator-registry-contract-addresses-holesky) for relevant contract addresses.
...
We expect all known relays to support opting-in to mev-commit within a few months of being live on mainnet. If you are a relay looking to join the mev-commit network please visit our [Relays page](/v1.0.0/get-started/relays) to get more information.
