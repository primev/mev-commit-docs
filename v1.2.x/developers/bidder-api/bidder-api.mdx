...
The same API is also available on the HTTP port configured on the node. Please review the [API docs](/v1.2.x/api-reference/bidder/sendbid) to understand the usage.
