...
| Block explorer    | [http://mev-commit.xyz](http://mev-commit.xyz)               |

# Contracts deployed to mev-commit chain

### **Core Contracts**

import { BidderRegistryAddressMainnet1_2_0, ProviderRegistryAddressMainnet1_2_0, PreconfManagerAddressMainnet1_2_0, OracleAddressMainnet1_2_0, BlockTrackerAddressMainnet1_2_0 } from '/snippets/mainnet-addresses.mdx';
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>{BidderRegistryAddressMainnet1_2_0}</td>
    </tr>
    <tr>
      <td>ProviderRegistry</td>
      <td>{ProviderRegistryAddressMainnet1_2_0}</td>
    </tr>
    <tr>
      <td>PreconfManager</td>
      <td>{PreconfManagerAddressMainnet1_2_0}</td>
    </tr>
    <tr>
      <td>Oracle</td>
      <td>{OracleAddressMainnet1_2_0}</td>
    </tr>
    <tr>
      <td>BlockTracker</td>
      <td>{BlockTrackerAddressMainnet1_2_0}</td>
    </tr>
  </tbody>
</table>
...
import { SettlementGatewayMainnet1_2_0 } from '/snippets/mainnet-addresses.mdx';
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>{SettlementGatewayMainnet1_2_0}</td>
    </tr>
  </tbody>
</table>
...
import { L1GatewayMainnet1_2_0Proxy, L1GatewayMainnet1_2_0Implementation } from '/snippets/mainnet-addresses.mdx';
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>
        <a href={`https://etherscan.io/address/${L1GatewayMainnet1_2_0Proxy}`} target="_blank" rel="noopener noreferrer">
          {L1GatewayMainnet1_2_0Proxy}
        </a>
      </td>
    </tr>
    <tr>
      ...
      <td>
        <a href={`https://etherscan.io/address/${L1GatewayMainnet1_2_0Implementation}`} target="_blank" rel="noopener noreferrer">
          {L1GatewayMainnet1_2_0Implementation}
        </a>
      </td>
    </tr>
  </tbody>
...
import { 
  ...
  VanillaReputationalProxyAddress,
  VanillaReputationalImplementationAddress,
  ValidatorOptInHubProxyAddress,
  ValidatorOptInHubImplementationAddress
...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td rowspan="2">Reputational VanillaRegistry</td>
      <td style={{ textAlign: 'center' }}>Proxy</td>
      <td>
        <a href={`https://etherscan.io/address/${VanillaReputationalProxyAddress}`} target="_blank" rel="noopener noreferrer">
          {VanillaReputationalProxyAddress}
        </a>
      </td>
    </tr>
    <tr>
      <td style={{ textAlign: 'center' }}>Implementation</td>
      <td>
        <a href={`https://etherscan.io/address/${VanillaReputationalImplementationAddress}`} target="_blank" rel="noopener noreferrer">
          {VanillaReputationalImplementationAddress}
        </a>
      </td>
    </tr>
    ...
    <tr>
      <td rowspan="2">ValidatorOptInHub</td>
      <td style={{ textAlign: 'center' }}>Proxy</td>
      <td>
        <a href={`https://etherscan.io/address/${ValidatorOptInHubProxyAddress}`} target="_blank" rel="noopener noreferrer">
          {ValidatorOptInHubProxyAddress}
        </a>
      </td>
    </tr>
    <tr>
      <td style={{ textAlign: 'center' }}>Implementation</td>
      <td>
        <a href={`https://etherscan.io/address/${ValidatorOptInHubImplementationAddress}`} target="_blank" rel="noopener noreferrer">
          {ValidatorOptInHubImplementationAddress}
        </a>
      </td>
    </tr>
