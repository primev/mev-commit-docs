...
import { BidderRegistryAddress, BlockTrackerAddress, OracleAddress, PreconfManagerAddress, ProviderRegistryAddress } from '/snippets/testnet-addresses.mdx';
...
import { HoodiValidatorOptInRouterAddress, HoodiValidatorOptInHubAddress, HoodiVanillaRegistryAddress, HoodiMevCommitAVSAddress, HoodiMevCommitMiddlewareAddress, HoodiRocketMinipoolRegistryAddress, HoodiLidoRegistryAddress } from '/snippets/testnet-addresses.mdx';
...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td>ValidatorOptInHub</td>
      <td>{HoodiValidatorOptInHubAddress}</td>
    </tr>
    <tr>
    ...
    <tr>
     ...
     <tr>
      <td>Lido Registry</td>
      <td>{HoodiLidoRegistryAddress}</td>
    </tr>
     <tr>
      <td>RocketMinipoolRegistry</td>
      <td>{HoodiRocketMinipoolRegistryAddress}</td>
    </tr>
  </tbody>
</table>
...
Please refer to the System Requirements section [here.](/v1.2.x/developers/system-requirements)
