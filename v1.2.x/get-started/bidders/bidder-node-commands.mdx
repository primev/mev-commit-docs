...
<Note>Ensure you have completed the [Quickstart](/v1.2.x/get-started/quickstart) step in a separate terminal. This will set up your environment and spin up a bidder node.</Note>
...
If you followed the [Quickstart](/v1.2.x/get-started/quickstart) exactly, your bidder node will already have the deposit manager enabled. To confirm:
...
This is the method used by the [Quickstart](/v1.2.x/get-started/quickstart).
