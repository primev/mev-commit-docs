...
### Bid Decay
The `decayStartTimestamp` and `decayEndTimestamp` are important components for how sensitive the [price of a preconfirmation](/v1.2.x/knowledge-base/how-to-price-a-bid) will be. More details can be found about it [here](/v1.2.x/concepts/bids/bid-structure#details-on-decay-parameters).
...
## Troubleshooting
Bidders will start receiving commitments instantly in most cases. If you're having trouble receiving commitments, check your bid parameters and ensure your bid is high enough for the commitment you're requesting. Additionally check that you are connected to providers (via the [topology endpoint](/v1.2.x/get-started/bidders/bidder-node-commands#topology)) and that you are receiving mev-commit events (via the [health endpoint](/v1.2.x/get-started/bidders/bidder-node-commands#health)).
...
Read more about the deposit manager [here](/v1.2.x/get-started/bidders/bidder-node-commands#deposit-manager).
