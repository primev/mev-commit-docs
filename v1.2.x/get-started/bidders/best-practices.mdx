...
### Bid Options
The `bidOptions` can be used to set positional constraints on the transactions or bundles in the block. Know more about the different [options here](https://docs.primev.xyz/v1.2.x/concepts/bids/bid-structure#details-on-bidOptions)
