...
* Relays must change the provider registry address used to query provider registrations. The new address will be available soon, and will be available at [https://contracts.mev-commit.xyz/](https://contracts.mev-commit.xyz/) or the [mainnet docs page](https://docs.mev-commit.xyz/v1.2.x/developers/networks).
