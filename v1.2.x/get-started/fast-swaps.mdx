...
<Steps>
  <Step title="Go to Fast Swaps">
    ...
    <Frame>
      {/* TODO: Screenshot of the Fast Swaps landing page at fastprotocol.io showing the swap interface */}
      <img src="/v1.2.x/images/fastswaps-landing.png" alt="Fast Swaps landing page showing the swap interface with Sell and Buy fields" />
    </Frame>
  </Step>
  ...
  <Step title="Connect Your Wallet">
    ...
    <Frame>
      ...
      <img src="/v1.2.x/images/fastswaps-connect-button.png" alt="Connect Wallet button highlighted in the Fast Swaps header" />
    </Frame>
  ...
  <Step title="Approve the Token (First Time Only)">
    ...
    **This step only applies to ERC-20 token swaps** (e.g., USDC → ETH). If you are swapping **ETH as the input token**, skip to the next step.
    ...
    <Frame>
      ...
      <img src="/v1.2.x/images/fastswaps-approve.png" alt="Fast Swaps showing the Approve button for first-time Permit2 token approval" />
    </Frame>
  ...
  <Step title="Sign in Your Wallet">
    ...
    <Frame>
      ...
      <img src="/v1.2.x/images/fastswaps-wallet-sign.png" alt="Wallet extension showing the EIP-712 signature request for the Fast Swaps swap intent" />
    </Frame>
  ...
  <Step title="Receive Preconfirmation">
    ...
    <Frame>
      {/* TODO: Screenshot or GIF of the swap confirmation toast showing the preconfirmed state */}
      <img src="/v1.2.x/images/fastswaps-toast-preconfirmed.png" alt="Swap confirmation toast showing preconfirmed status with token pair and amounts" />
    </Frame>
