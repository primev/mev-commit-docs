...
import { HoodiLidoRegistryAddress } from '/snippets/testnet-addresses.mdx';
...
### Step 2: Only use our opted-in relays

Ensure your mev-boost client only connects to [mev-commit opted-in relays](/v1.2.x/get-started/validators/validator-guide#supporting-relays).
