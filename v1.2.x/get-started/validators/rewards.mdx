...
*   **Address**: [0x69f286fc7869c30809a9695462fa79a0fd99c5bc](https://hoodi.etherscan.io/address/0x69f286fc7869c30809a9695462fa79a0fd99c5bc#writeContract)

## Interacting with the Contract

The Rewards Distributor is currently live on the [Hoodi testnet](https://hoodi.etherscan.io/address/0x69f286fc7869c30809a9695462fa79a0fd99c5bc#writeContract). A Mainnet deployment and a dedicated claiming UI will be available in the future.

For now, you can manage and claim rewards programmatically or by interacting directly with the contract on Etherscan.

## Claiming rewards

Rewards do not stream automatically to your wallet; you must explicitly [claim them from the contract](https://hoodi.etherscan.io/address/0x69f286fc7869c30809a9695462fa79a0fd99c5bc#writeContract).
