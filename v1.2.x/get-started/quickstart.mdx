---
title: "Quickstart for mev-commit node"
...
<Steps>
  <Step title="Bridge to the mev-commit chain">
    ...
    You can move forward while the bridge transaction completes in ~15m (detailed instructions in our [Bridge UI guide](/v1.2.x/get-started/bridge/bridge)). 

    <Accordion title="CLI alternative for bridging (supports testnet)">
...
<Accordion title="❗🕵️‍♂️ Tips">
    ...
    Providers may continue to the [Registration steps](https://docs.primev.xyz/v1.2.x/get-started/providers/registering-a-provider).
