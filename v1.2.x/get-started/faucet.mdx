...
<Note>This faucet is for Providers and Bidders only, Validators please visit the faucet links listed on [this](/v1.2.x/get-started/validators) page for Hoodi ETH. </Note>
...
<Frame>
  <img src="/v1.2.x/images/faucet.png" />
</Frame>
