...
description: "Primev builds Fast Protocol — an ecosystem of products that make Ethereum fast, fair, and efficient through mev-commit preconfirmations, mev redistribution, and real-time settlement."
mode: "wide"
icon: "sailboat"
---
...
Primev builds **Fast Protocol** — an ecosystem of products that make Ethereum fast, fair, and efficient. Powered by [mev-commit](/v1.2.x/concepts/mev-commit-intro/what-is-mev-commit) preconfirmations, Fast Protocol captures mev and redistributes it back to users, while giving transactions near-instant finality on Ethereum.
...
If you are a participant in the mev-commit network, visit the [quickstart guide](/v1.2.x/get-started/quickstart) or explore the resources below for your role:
...
Our mission at Primev is to solve coordination inefficiencies in decentralized domains additively to mev, driving network welfare and increasing transparency and decentralization of the mev pipeline.
