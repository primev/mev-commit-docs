...
description: "We build [mev-commit](/v1.2.x/concepts/mev-commit-intro/what-is-mev-commit), the preconfirmation protocol that makes Ethereum fast. mev-commit gives transactions near-instant finality by letting block builders commit to including them before a block is produced."
mode: "wide"
icon: "sailboat"
---
