...
You can either visit our [quickstart guide](/v1.2.x/get-started/quickstart) which is tailored to your specific role within the Ethereum ecosystem and designed to get you up and running quickly.
...
<CardGroup cols={3}>
    ...
    <QuickStartCard title="Bidders" icon="user-bounty-hunter" >
        ...
        <QuickStartCardFooter>
            ...
            <p>• [Send Transactions to Providers](/v1.2.x/get-started/bidders/best-practices#provider-rpcs)</p>
    ...
    <QuickStartCard title="Providers" icon="network-wired">
        ...
        <QuickStartCardFooter>
            ...
            <p>• [Querying for Proposers](/v1.2.x/get-started/providers/Querying-for-proposers)</p>
            <p>• [Hyperliquid Network](/v1.2.x/developers/networks/hyperliquid)</p>
        </QuickStartCardFooter>
    </QuickStartCard>
...
See [FAST RPC](/v1.2.x/get-started/fastrpc) to use with your dapp or wallet
.
