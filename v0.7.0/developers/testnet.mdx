...
import { BidderRegistryAddress0_7_0, ProviderRegistryAddress0_7_0, PreconfManagerAddress0_7_0, OracleAddress0_7_0, BlockTrackerAddress0_7_0 } from '/snippets/testnet-addresses.mdx';
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>{PreconfManagerAddress0_7_0}</td>
    </tr>
    <tr>
      <td>Oracle</td>
...
### **Settlement Gateway Contract Addresses (Mev-commit chain)**
...
### **L1 Gateway address (Holesky)**

import { L1Gateway } from '/snippets/testnet-addresses.mdx';
...
Please refer to the System Requirements section [here.](/v0.7.0/developers/system-requirements)
