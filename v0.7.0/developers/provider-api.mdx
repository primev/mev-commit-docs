...
The same API is also available on the HTTP port configured on the node. Please review the [API docs](/v0.7.0/api-reference/provider/receivebids) to understand the usage.
