...
<Accordion title="🤔 What does the script do?">
  ...
  <Step title="Fund Your Account">
    To fund your account, please visit our [Testnet Faucet](/v0.7.0/get-started/faucet). Details about the account address will be displayed after running the command above.
  </Step>
