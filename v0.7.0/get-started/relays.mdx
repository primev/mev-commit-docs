...
<Frame>
  <img src="/v0.7.0/images/relay-filtering.png" alt="Relay filtering diagram" />
</Frame>
...
PROVIDER_REGISTRY_ADDR={ProviderRegistryAddress}
  ...
  <Step title="Register Your Relay">
    1. Add your relay to our [supporting relays list](https://github.com/primev/mev-commit-docs/blob/main/v0.7.0/get-started/validators.mdx)
