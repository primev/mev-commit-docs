...
<Frame>
  <img src="/v0.7.0/images/symbiotic.png" alt="Diagram showing the relationship between Vaults, Operators, Network Middleware, and the mev-commit Oracle" />
</Frame>
...
The Network in this context is mev-commit. Our network is represented by a network address, and a middleware contract. Both of which can be found on the [testnet](/v0.7.0/developers/testnet#validator-registry-contract-addresses-holesky) page. Mainnet support is coming soon.
