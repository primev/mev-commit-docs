...
<Columns cols={2}>
  <Card title="For dApps" icon="panel-left-close">
    <p>[FAST RPC Usage Instructions for dApps](#usage-for-dapps)</p>
  </Card>
  <Card title="For Wallets" icon="panel-right-close">
    <p>FAST RPC [Usage Instructions for wallets and wallet users](#usage-for-wallets)</p>
  </Card>
</Columns>
