...
<Columns cols={2}>
  <Card title="For dApps" icon="network"> {/* Changed icon to 'network' */}
    <p><span style={{ textDecoration: 'underline' }}>[FAST RPC Usage Instructions for dApps](#usage-for-dapps)</span></p>
  </Card>
  <Card title="For Wallets" icon="wallet"> {/* Changed icon to 'wallet' */}
    <p>FAST RPC <span style={{ textDecoration: 'underline' }}>[Usage Instructions for wallets and wallet users](#usage-for-wallets)</span></p>
  </Card>
</Columns>
