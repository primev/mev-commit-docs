...
<Note>This faucet is for Providers and Bidders only, Validators please visit the faucet links listed on [this](/v1.1.0/get-started/validators) page for Hoodi ETH. </Note>
