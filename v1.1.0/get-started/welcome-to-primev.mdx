...
In this early stage, Hyperliquid support is available **via custom bootnode and privacy setup**. Read more in our [Hyperliquid integration guide](../networks/hyperliquid.md).
