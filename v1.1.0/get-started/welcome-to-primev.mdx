...
<CardGroup cols={3}>
    ...
    <QuickStartCard title="Providers" icon="network-wired">
        ...
        <QuickStartCardFooter>
            ...
            <p>• [Relay Guide](/v1.1.0/get-started/relays)</p>
        </QuickStartCardFooter>
    </QuickStartCard>
...
Hyperliquid support is available **via custom bootnode and privacy setup**. See [Hyperliquid Network](/v1.1.0/developers/networks/hyperliquid)
.
