...
### New: Hyperliquid Support (Early Access)

We're extending mev-commit to support **Hyperliquid** — a novel L1 built for high-performance order execution. 🎉

In this early stage, Hyperliquid support is available **via custom bootnode setup**. You can read more in our [Hyperliquid integration guide](../networks/hyperliquid.md).

> Native support for multiple networks will be introduced in a future release.
