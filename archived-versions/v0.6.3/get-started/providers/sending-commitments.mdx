...
<Tip>You will want to connect to a decisioning system that will accept and reject bids based on custom criteria. You can read more about the API to open a gRPC stream [here](/v0.6.3/api-reference/provider/sendprocessedbids).</Tip>
...
![gRPC Flow for Getting Bids](/v0.6.3/images/grpc-flow-getbids.png)
</Step>
