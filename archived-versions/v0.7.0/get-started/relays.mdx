...
<Frame>
  <img src="/v0.7.0/images/mev-commit-relay.png" alt="mev-commit relay diagram" />
</Frame>

- If they have opted in, your relay only accepts blocks from mev-commit builders:
<Frame>
  <img src="/v0.7.0/images/mev-commit-validator-relay.png" alt="mev-commit validator relay diagram" />
</Frame>
...
PROVIDER_REGISTRY_ADDR={ProviderRegistryAddress0_7_0}
  ...
  <Step title="Test and Deploy">
    ...
    - Register a [test builder](/v0.7.0/get-started/quickstart)
    - Submit [test bids](/bidders/best-practices#submit-bundles)
    - Verify correct block filtering 
  </Step>

  <Step title="Register Your Relay">
    1. Add your relay to our [supporting relays list](/v0.7.0/get-started/validators/validator-guide#supporting-relays)
