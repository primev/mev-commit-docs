...
This action confirms a validator’s attestation to follow the relay selection rule mentioned in the [Validator Guide](/v0.7.0/get-started/validators/validator-guide#requirements).
...
To vanilla stake validator pubkeys, navigate to the [mainnet](https://validators.mev-commit.xyz/) or [holesky](https://holesky.validators.mev-commit.xyz/dashboard) validator dashboard. Choose "Opt-in", confirm the relevant validator's relays have been correctly configured as specified in the [Validator Guide](/v0.7.0/get-started/validators/validator-guide#requirements), then choose the "Simple" staking route.
