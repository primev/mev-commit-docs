...
<Warning>
  This is an older version of the documentation. We have now moved to version v0.7.0. Please visit the latest documentation at [v0.7.0/get-started/welcome-to-primev](/v0.7.0/get-started/welcome-to-primev).
</Warning>
...
<CardGroup cols={3}>
    ...
    <QuickStartCard title="Validators" icon="ethereum">
	    ...
	    • [Eigenlayer Operator Registration](/v0.6.3/knowledge-base/eigenlayer-operator-registration)
