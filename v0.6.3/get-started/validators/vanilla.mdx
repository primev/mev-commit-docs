...
Simple staking (aka vanilla staking) is the most straightforward method to opt-in to mev-commit and requires minimal setup. The vanilla registry allows validators to be opted-in directly by staking native ETH.
