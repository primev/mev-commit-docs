...
On the other hand, this method of opt-in is not as capital efficient as using Symbiotic or Eigenlayer. As the ETH used to opt-in validators is completely separate from a validator's 32 ETH already staked with the beacon chain and cannot be restaked.
