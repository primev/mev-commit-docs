...
Users bidding for execution services include **mev searchers, AA bundlers, solvers, Rollup Provers, and others seeking efficient use of block space**. For detailed roles and interactions, refer to the [Actors](./#actors) section.
