...
The earliest withdrawal time can be calculated as follows: the withdrawal start time plus 10 L1 blocks (which is 120 seconds or 2 minutes) and the oracle lag of 10 L1 blocks (which is 120 seconds or 2 minutes), totaling 240 seconds or 4 minutes. Therefore, the total time before funds can be withdrawn is approximately 20 blocks (4 minutes) from the initial deposit.
