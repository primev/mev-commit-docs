...
The earliest withdrawal time can be calculated as the withdrawal start time, n-2 windows which is 30 L1 blocks (360 seconds) and oracle lag which is 10 L1 blocks (120 seconds) totalling 480 seconds, or 10 minutes. Therefore, the total time before funds can be withdrawn is approximately 40 blocks (8 minutes) from the initial deposit.
