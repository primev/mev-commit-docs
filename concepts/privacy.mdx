...
## Bidder Privacy
Each bidder can select a group of providers to access their bids, establishing a direct private channel with each provider. The bids are then sent through these private channels. Other bidders and providers remain unaware of the bid details as the contents are encrypted. Furthermore, even after a provider commits to a bid, the bidder's privacy is preserved, as the commitment reveals no information about the bid to third parties.
