...
- **Proposers**: Validators who are positioned to propose a block to the network. As prime providers of execution services, they outsource this process to block builders by using mev-boost. As the mev pipeline evolves, they make have additional preferences or an Inclusion List to communicate to other execution service providers.
