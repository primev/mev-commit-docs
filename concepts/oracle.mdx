...
- A smart contract component [here](https://github.com/primev/contracts/blob/main/contracts/Oracle.sol).
- A microservice [here](https://github.com/primev/mev-commit-oracle).
