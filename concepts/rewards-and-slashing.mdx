...
<Note>An important observation here is that due to the preconf commitments the provider will have additional value to bid in the mev-boost auction, thus driving up the total revenue a proposer will get, in contrast to just using mev-boost alone.</Note>
