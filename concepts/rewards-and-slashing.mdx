...
❗ The Bidder needs to have 10 times the size of their largest bid in order for their bid to be considered valid and to receive commitments. Providers also need to ensure they have 10 times the stake of a bidAmt to commit to a bid.
