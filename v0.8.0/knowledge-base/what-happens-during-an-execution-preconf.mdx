...
<img height="200" src="/v0.8.0/images/preconf-process.svg" />
...
<Step title="Setting up your mev-commit bidder node">
   ...
   - Follow the [Quickstart guide](/v0.8.0/get-started/quickstart) to set up your mev-commit bidder node and fund your account.
</Step>
