...
The Network in this context is mev-commit. Our network is represented by a network address, and a middleware contract. Both of which can be found on the [testnet](/v0.8.0/developers/testnet) page. Mainnet support is coming soon.
