...
If you plan to bulk opt-in a large number of validator pubkeys, check out the [Eigenlayer Operator Registration](/v0.8.0/developers/eigenlayer-operator-registration) guide.
