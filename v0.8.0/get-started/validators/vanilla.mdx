...
This action confirms a validator’s attestation to follow the relay selection rule mentioned in the [Validator Guide](/v0.8.0/get-started/validators/validator-guide#requirements).
