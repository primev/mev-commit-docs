...
Relevant contract addresses can be found on the [testnet page](/v0.8.0/developers/testnet).

Select one of the tabs below for a walkthrough of how to opt-in.
...
<Tabs>
  ...
  <Tab title="Simple Staking">
    ...
    * [Automata Faucet](https://www.holeskyfaucet.io/)
    ...
    If you want to stake your keys manually, please visit [Stake Validators Keys Manually](/v0.8.0/developers/stake-validator-keys-manually) section.
  </Tab>
</Tabs>
