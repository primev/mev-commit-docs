...
You can either visit our [quickstart guide](/v0.8.0/get-started/quickstart) which is tailored to your specific role within the Ethereum ecosystem and designed to get you up and running quickly.
...
<CardGroup cols={3}>
    ...
    <QuickStartCard title="Bidders" icon="user-bounty-hunter" >
        ...
        <QuickStartCardFooter>
            • [Quickstart Your Node](/v0.8.0/get-started/quickstart)

            • [Send Transactions to Providers](/v0.8.0/get-started/bidders/best-practices#provider-rpcs)
             
            • [Node Commands](/v0.8.0/get-started/bidders/bidder-node-commands)
			
	    • [Bid Structure](/v0.8.0/concepts/bids/bid-structure)

            • [Bidder Deposit](/v0.8.0/concepts/bids/bidder-deposit)
			
	    • [Bid Decay](/v0.8.0/concepts/bids/bid-decay-mechanism)
    ...
    <QuickStartCard title="Providers" icon="network-wired">
        ...
        <QuickStartCardFooter>
            • [Registering as a Provider](/v0.8.0/get-started/providers/registering-a-provider)

            • [Consuming Bids](/v0.8.0/get-started/providers/consuming-bids)

            • [Sending Commitments](/v0.8.0/get-started/providers/sending-commitments)

            • [Commitments Structure](/v0.8.0/concepts/commitments)

            • [Querying for Proposers](/v0.8.0/get-started/providers/Querying-for-proposers)
			
			• [Relay Guide](/v0.8.0/get-started/relays)
    ...
    <QuickStartCard title="Validators" icon="ethereum">
        ...
        <QuickStartCardFooter>
            • [Opting-in as a Validator](/v0.8.0/get-started/validators)

	    • [Eigenlayer Operator Registration](/v0.8.0/knowledge-base/eigenlayer-operator-registration)

            • [Validator Considerations](/v0.8.0/concepts/validator-considerations)
