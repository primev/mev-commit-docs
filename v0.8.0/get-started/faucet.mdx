...
<Note>This faucet is for Providers and Bidders only, Validators please visit the faucet links listed on [this](/v0.8.0/get-started/validators) page for Holesky ETH. </Note>
...
<Frame>
  <img src="/v0.8.0/images/faucet.png" />
</Frame>
