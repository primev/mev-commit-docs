...
<Tip>You will want to connect to a decisioning system that will accept and reject bids based on custom criteria. You can read more about the API to open a gRPC stream [here](/v0.8.0/api-reference/provider/sendprocessedbids).</Tip>
...
git checkout v0.8.0 && cd p2p/examples/provideremulator && go run . 
```
...
![gRPC Flow for Getting Bids](/v0.8.0/images/grpc-flow-getbids.png)
</Step>
