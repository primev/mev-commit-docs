...
<Tip>You will want to connect to a decisioning system that will accept and reject bids based on custom criteria. You can read more about the API to open a gRPC stream [here](/api-reference/provider/sendprocessedbids).</Tip>
