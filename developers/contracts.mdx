...
The [mev-commit contracts](https://github.com/primev/contracts) verify and manage the movement of funds as a response to bid and commitment activities that occur on our p2p network.
