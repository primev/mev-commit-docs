...
A `ValidatorOptInRouter` contract is also deployed on L1, enabling actors to query whether a validator is opted-in to the mev-commit protocol from any of the three methods.
