...
<Steps titleSize="h3">
  ...
  <Step title="Get the mev-commit binary">
    ...
    Navigate to the [mev-commit repo](https://github.com/primevprotocol/mev-commit/releases/latest)
    ...
    curl -L \
    "https://github.com/primevprotocol/mev-commit/releases/download/v0.3.0-rc2/$FILENAME" \
    | tar -xz -C $HOME
    ```
    ...
    <Steps>
      ...
      <Step title="Grab the checksum">
        ...
        FILENAME="mev-commit_$(uname -s)_$(uname -m).tar.gz"
        CHECKSUM=$(curl -L \
        "https://github.com/primevprotocol/mev-commit/releases/download/v0.3.0-rc2/mev-commit_v0.3.0-rc2_checksums.txt" \
  ...
  <Step title="Initialize mev-commit">
    ...
    Navigate to the directory with the mev-commit binary and execute the initialization command:
      ...
      <CodeGroup>
        ...
        ./mev-commit init \
        --dir . \
        --rpc-endpoint https://chainrpc.testnet.mev-commit.xyz \
        --peer-type bidder
        ```
   ...
   <div className="inline-card-header">
    ...
    <div className="inline-card-header">
      <Card title="Providers" icon="network-wired">
         <br/><br/>
         In order to register as a provider please go through the [registration process](../get-started/providers/register-a-provider).
      </Card>
    </div>
</CardGroup>
