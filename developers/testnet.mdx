...
import { BidderRegistryAddress, ProviderRegistryAddress, PreConfCommitmentStoreAddress, OracleAddress, WhitelistAddress, BlockTrackerAddress } from '/snippets/testnet-addresses.mdx';
