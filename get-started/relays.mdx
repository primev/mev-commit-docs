...
Information about the providers (entities like builders who commit on our network) is stored the provider registry hosted on the mev-commit chain. You can interact with the registry at the contract address at http://explorer.testnet.mev-commit.xyz/contracts/{ProviderRegistryAddress}. 
<AccordionGroup>
