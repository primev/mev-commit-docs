...
Start by cloning the [mev-commit-bridge](https://github.com/primevprotocol/mev-commit-bridge) and build the user CLI for your machine from the `standard/bridge-v1` directory:
...
<CardGroup cols={2}>
  <div className="inline-card-header">
    <Card title="Bidders" icon="user-bounty-hunter">
      <br />
      <br />
      Once the you have bridged your funds you can move on to [funding
  ...
  <div className="inline-card-header">
    <Card title="Providers" icon="network-wired">
      <br />
      <br />
      Once you have funded your account on the mev-commit chain, in order to register as a provider, please go through the [registration
