...
Ready to get your node up and running? The codes below are all you need to launch either a bidder or provider node on the mev-commit network.
...
<Note>
        To fund your account, please visit <a href="http://faucet.testnet.mev-commit.xyz/">http://faucet.testnet.mev-commit.xyz/</a>. Details about the account address will be displayed after running the commands above.
</Note>
<br></br>

<Accordion title="🤔 What does the script do?"defaultOpen={true}>
...
If you want to perform a manual setup with detailed steps, please skip to the [manual start mev-commit](/developers/manual-start-mev-commit) section.
