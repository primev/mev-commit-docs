...
icon: "gear"
---
<Tip>Please select either the Bidder or Provider tab below to proceed with the setup instructions specific to your role.</Tip>
<Tabs>
  <Tab title="Bidder">
...
Make sure to check [System Requirements](/developers/system-requirements) to better understand what is needed to run mev-commit without any interruptions.	
