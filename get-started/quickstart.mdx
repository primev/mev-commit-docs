...
<Steps titleSize="h3">
  ...
  <Step title="🚀 Launch">
    ...
    <CodeGroup>
        ...
        ```bash ❯_ provider
        ./launchmevcommit --node-type provider
        ```

    </CodeGroup>

    <Note>
      You need to make sure that the peer-to-peer port 13522 on your local machine is accessible through a public IP address.
      This setup enables the provider node to initiate incoming connections to your node.
    </Note>
...
<Accordion title="🤔 What does the script do?">
    ...
    ### 2. Download
    - Fetches the appropriate mev-commit binary for your system from the [Primev GitHub releases page](https://github.com/primevprotocol/mev-commit/releases/latest), considering your operating system and architecture.
...
Make sure you visit [Bridging Funds](get-started/bridging-funds) and bridge your funds before you move on to the **Bidders** or **Providers** sections. 