...
<Note>
        To fund your account, please visit <a href="http://faucet.testnet.mev-commit.xyz/">http://faucet.testnet.mev-commit.xyz/</a>. Details about the account address will be displayed after running the commands below.
</Note>
<br></br>
