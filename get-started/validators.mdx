...
A frontend UI for the validator registry is in progress. For now, you can programmatically interact with the registry via [forge script](https://book.getfoundry.sh/reference/forge/forge-script).
...
Invocation of the contract from said script would look like:
