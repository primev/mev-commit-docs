...
* 3 ETH must be staked with the registry contract on the mev-commit chain for the validator account, which you can obtain from our faucet for the testnet. See below for further instructions.
