...
<Note> For seamless availability of funds, the deposits would be locked for around 4 windows at a time. So the total amount locked would be `4 * amountPerWindow`. The user's wallet should have enough funds to be able to maintain these deposits as well as cover gas costs to issue transactions.</Note>
