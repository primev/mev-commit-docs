...
For example, to query the full set of staked validators, use [this example script](https://github.com/primevprotocol/validator-registry/blob/main/cmd/query/main.go) as described below.
