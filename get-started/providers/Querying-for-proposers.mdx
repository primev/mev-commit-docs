...
This script can act as a starting point for integrating validator registry queries into your own tooling. The contract's go binding is available [here](https://github.com/primev/validator-registry/blob/main/pkg/validatorregistry/ValidatorRegistry.go).
