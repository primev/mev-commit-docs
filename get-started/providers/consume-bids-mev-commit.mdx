...
*   Use the official go RPC client to communicate with your mev-commit node. Go get the mev-commit package and then import the generated client as below:
    ...
    2. Incorporate the generated client into your Go application as follows:
...
2. Check the [API docs](https://primev-24.mintlify.app/api-reference/provider/sendprocessedbids) to use the REST APIs. The RPC APIs are also available on the HTTP server.
