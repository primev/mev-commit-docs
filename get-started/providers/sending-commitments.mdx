...
``` git clone https://github.com/primev/mev-commit.git && cd mev-commit &&
...
Implement the Provider service as outlined in the [providerapi.proto](https://github.com/primev/mev-commit/blob/main/rpc/providerapi/v1/providerapi.proto#L20). This requires setting up a server that can manage RPC methods, with a particular emphasis on the reception of bids and response of commitment authorizations.
...
import (
	...
	"github.com/primev/mev-commit/examples/provideremulator/client"
	providerapiv1 "github.com/primev/mev-commit/gen/go/providerapi/v1"
)
