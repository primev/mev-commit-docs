...
Now you'll want to connect a decisioning system that will accept and reject bids based on custom criteria. You can read more about the internal builder API [here](/api-reference/provider/sendprocessedbids).
