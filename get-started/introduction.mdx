...
<CardGroup cols={3}>
    ...
    <QuickStartCard title="Validators" icon="ethereum">
        ...
        <CardContent>
            Validators add ultimate credibility to commitments within the mev-commit network. Start here to participate in the mev-commit protocol as a Holesky validator.
        </CardContent>
