...
## Funding Your Node on the Testnet

<p>To facilitate your interaction with the mev-commit Testnet, we provide a convenient method to fund your node with Ether using our dedicated faucet. By visiting our testnet [faucet page](http://faucet.testnet.mev-commit.xyz/), you can easily request up to 10 ETH per request for your wallet.</p>    
